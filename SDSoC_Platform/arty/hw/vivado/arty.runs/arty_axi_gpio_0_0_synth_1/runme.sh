...
HD_PWD='Z:/20170720_arty/Arty/Vivado/arty/arty.runs/arty_axi_gpio_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log arty_axi_gpio_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source arty_axi_gpio_0_0.tcl
