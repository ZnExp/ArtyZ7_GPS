...
HD_PWD='Z:/20170720_arty/Arty/Vivado/arty_uart1/arty.runs/arty_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log arty_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source arty_xbar_0.tcl
