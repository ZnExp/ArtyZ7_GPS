...
HD_PWD='Z:/20170720_arty/Arty/Vivado/arty_uart1/arty.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log arty_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source arty_wrapper.tcl -notrace
